...
const initialState = {
  activeId: null, // ID активного чата
  allIds: [], // Массив идентификаторов всех (id) чатов
  myIds: [], //  Массив идентификаторов всех (id) чатов в которых состоит пользователь
  byIds: {} // Объект со всеми id (id - обьект чата)
};
